...
export default function Adopted() {
  ...
  const getAdoptedSortValue = (dog, key) => {
    switch (key) {
        ...
        <table>
          <thead>
            <tr>
              ...
              <SortableTh label="Date Adopted" sortKey="disposition_date" sort={sort} onSort={toggleSort} />
              <SortableTh label="Adopter's Name" sortKey="disposition_contact_name" sort={sort} onSort={toggleSort} />
              <SortableTh label="Adopter's Address" sortKey="disposition_contact_address" sort={sort} onSort={toggleSort} />
